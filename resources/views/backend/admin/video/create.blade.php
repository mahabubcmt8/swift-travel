                ...
                <div class="row m-4">
                  ...
                  <div class="col-md-12">
                    <div class="form-group">
                       ...
                       <input type="text" name="tour_country" value="{{ old('tour_country') }}" id="tour_country" class="form-control" placeholder="Enter tour country name">
                       @error('tour_country')
                       <span class="text-danger">{{ $message }}</span>
                       @enderror
                    </div>
                 ...
                 <div class="col-md-12">
                    <div class="form-group">
                       ...
                       <input type="text" min="0" name="tour_day" value="{{ old('tour_day') }}" id="tour_day" class="form-control" placeholder="Enter tour day">
                       @error('tour_day')
                       <span class="text-danger">{{ $message }}</span>
                       @enderror
                    </div>
                 ...
                 <div class="col-md-12">
                    <div class="form-group">
                       ...
                       <input type="text" name="video_url" value="{{ old('video_url') }}" id="video_url" class="form-control" placeholder="Enter video url">
                       @error('video_url')
                       <span class="text-danger">{{ $message }}</span>
                       @enderror
                    </div>
