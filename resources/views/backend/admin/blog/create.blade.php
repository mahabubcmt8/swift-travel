                ...
                <div class="row m-4">
                  <div class="col-md-12">
                     <div class="form-group">
                        ...
                        <input type="text" name="title" value="{{ old('title') }}" id="blog_title" class="form-control" placeholder="Write blog title">
                        @error('title')
                  ...
                  <div class="col-md-12">
                     <div class="form-group">
                        <label for="blog_image">Blog Image <span class="text-danger">(Size:1200,1700):</span></label>
                  ...
                  <div class="col-md-12">
                     <div class="form-group">
                        ...
                        <textarea class="summernote_content" id="blog_description" name="blog_description"></textarea>
                     </div>
