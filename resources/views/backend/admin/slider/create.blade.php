                ...
                <div class="row m-4">
                  <div class="col-md-12">
                     <div class="form-group">
                        ...
                        <input type="text" name="title" value="{{ old('title') }}" id="title" class="form-control" placeholder="Write slider title">
                        @error('title')
                  ...
                  <div class="col-md-12">
                     <div class="form-group">
                        <label for="slider_image">Slider Image <span class="text-danger">(Size:1920,1280):</span></label>
